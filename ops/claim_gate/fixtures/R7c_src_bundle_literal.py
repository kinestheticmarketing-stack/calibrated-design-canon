...
PANEL_JS = (
    "(function () { 'use strict'; var el = document.getElementById('panel-out'); if (!el) { return; } el.innerHTML = '<p>The newest rebate schedule, effective January 1, 2024, is the one your contractor files against.</p>'; el.classList.add('is-visible'); }());"
)
