"""R5 control: an uncited statistic inside a script bundle's string literal.
...
PANEL_JS = (
    "(function () { 'use strict'; var el = document.getElementById('panel-out'); if (!el) { return; } el.innerHTML = '<p>Our crews measure a real improvement in heating costs on every Denver attic we touch.</p>'; el.classList.add('is-visible'); }());"
)
