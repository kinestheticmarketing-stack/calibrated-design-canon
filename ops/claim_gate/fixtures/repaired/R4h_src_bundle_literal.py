...
PANEL_JS = (
    "(function () { 'use strict'; var el = document.getElementById('panel-out'); if (!el) { return; } el.innerHTML = '<p>The Whole Home Efficiency Bonus and the Xcel Insulation and Air Sealing Rebate each have their own separate terms.</p>'; el.classList.add('is-visible'); }());"
)
