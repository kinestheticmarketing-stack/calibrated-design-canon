...
PANEL_JS = (
    "(function () { 'use strict'; var el = document.getElementById('panel-out'); if (!el) { return; } el.innerHTML = '<p>Xcel Energy is the natural gas utility for most locations in Severance and files the rebate paperwork.</p>'; el.classList.add('is-visible'); }());"
)
